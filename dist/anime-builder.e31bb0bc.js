...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dist/AnimeBuilder.js":[function(require,module,exports) {
var define;
...
},{}],"src/js/ElementBox.js":[function(require,module,exports) {
"use strict";
...
exports.default = ElementBox;
},{}],"src/js/Guide.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Guide(selector) {
    ...
    this.el = new _ElementBox.default(selector);
  ...
  _createClass(Guide, [{
    ...
    value: function getCurrentPos() {
      ...
      var translateVals = getComputedTranslateXY(this.el.element);
    ...
    key: "goToContext",
    value: function goToContext(selector, options) {} // Options
    ...
    */
    ...
    key: "goAround",
    value: function goAround(selector, options) {}
  }, {
    key: "goAroundCW",
    value: function goAroundCW(selector) {}
  }], [{
    key: "animeMoveX",
    value: function animeMoveX(distance, _ref) {
      var _ref$duration = _ref.duration,
          duration = _ref$duration === void 0 ? 1000 : _ref$duration,
          _ref$trailLength = _ref.trailLength,
          trailLength = _ref$trailLength === void 0 ? 4 : _ref$trailLength;
      return {
        translateX: [{
          value: distance,
          duration: duration,
    ...
    key: "animeMoveY",
    value: function animeMoveY(distance, _ref2) {
      var _ref2$duration = _ref2.duration,
          duration = _ref2$duration === void 0 ? 1000 : _ref2$duration,
          _ref2$trailLength = _ref2.trailLength,
          trailLength = _ref2$trailLength === void 0 ? 4 : _ref2$trailLength;
      return {
        translateY: [{
          value: distance,
          duration: duration,
...
var _AnimeBuilder = _interopRequireDefault(require("./dist/AnimeBuilder"));

var _animejs = _interopRequireDefault(require("animejs"));

var _Guide = _interopRequireDefault(require("./src/js/Guide"));
...
var homepageCord = homepageEl.getBoundingClientRect();
var homepageStartCord = {
  x: homepageCord.right + (homepageCord.left - homepageCord.right) / 2,
  y: homepageCord.top - 5
};
var secondpageCord = secondpageEl.getBoundingClientRect();
var secondpageStartCord = {
...
var leftGuideA = (0, _animejs.default)({
  ...
  scaleX: [{
    value: 1,
    duration: guideSpeed * .5,
    easing: "easeInOutQuad"
  }, {
    value: 4,
    duration: guideSpeed * 2.5,
    easing: "easeInOutQuad"
  }, {
    value: 1,
    duration: guideSpeed * .5,
...
var rightGuideA = (0, _animejs.default)({
...
function changeView(e) {
  switch (e.target.id) {
    ...
    case "secondpage":
      {
        guideleft.style.left = "".concat(secondpageStartCord.x, "px");
        guideleft.style.top = "".concat(secondpageStartCord.y, "px");
        guideright.style.left = "".concat(secondpageStartCord.x, "px");
        guideright.style.top = "".concat(secondpageStartCord.y, "px");
        leftGuideA.reset();
        leftGuideA.play();
        rightGuideA.reset();
        rightGuideA.play();
...
.add(_Guide.default.animeMoveX(100, {
  ...
  duration: 200,
  trailLength: 12
})).add(_Guide.default.animeMoveX(200, {
  duration: 200,
  trailLength: 12
})).add(_Guide.default.animeMoveY(100, {
  duration: 200,
  ...
  duration: 200,
  trailLength: 12
})).add(_Guide.default.animeMoveY(300, {
  duration: 200,
  trailLength: 12
...
},{"./dist/AnimeBuilder":"dist/AnimeBuilder.js","animejs":"node_modules/animejs/lib/anime.es.js","./src/js/Guide":"src/js/Guide.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/anime-builder.e31bb0bc.map